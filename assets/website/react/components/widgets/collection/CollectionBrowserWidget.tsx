...
import { CollectionFilterGroup } from "@/react/components/widgets/collection/CollectionFilterGroup";
import { cn } from "@/lib/utils";
import AppPagination from "@/react/components/core/AppPagination";
          ...
          <div className="space-y-6">
            ...
            <div className="xl:pr-6">
              {filter.groupItems.map((item, index) => (
                <div className={cn("border-b border-gray-200 pb-3", { "pt-3": index != 0 })}>
